...
include_dirs = [
    '.',
    'third_party/go1_sdk/pybind11/include',
    ...
    'src/convex_mpc_controller'
]

# Sources for chance constraints module
sources_chance_constraints = [
  "src/convex_mpc_controller/chance_constraints.cc",
]
...
# Creating a separate module for chance constraints
# Only an additional source file is added
chance_constraints_ext = Extension("chance_constraints_cpp",
                                   sources=sources_chance_constraints,
                                   libraries=libraries,
                                   extra_compile_args=CXX_FLAGS.split(),
                                   include_dirs=include_dirs + ["."])

extensions = [mpc_osqp_ext,chance_constraints_ext]
